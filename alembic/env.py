...
# Allow ``SPLITSMITH_DATABASE_URL`` to override the URL baked into
# ``alembic.ini`` so docker-compose / CI / hosted-mode deployments
# don't need separate ini files.
if env_url := os.environ.get("SPLITSMITH_DATABASE_URL"):
